      ...
      <div class="container mx-auto px-4 relative">
        <div class="flex flex-wrap -mx-4 items-center mb-4">
          ...
          <div class="px-4 w-full lg:text-right lg:w-5/12">
            <BaseButton href="#" class role="primary-container"
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            <BaseSheet class="px-6 py-16 rounded-lg shadow-lg">
              <svg
              ...
              <BaseButton href="#" size="small" class="mt-6"
          ...
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            <BaseSheet
              class="px-6 py-16 rounded-lg shadow-lg sm:-mb-16 sm:mt-16"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            <BaseSheet class="px-6 py-16 rounded-lg shadow-lg">
              ...
              <BaseButton href="#" class="hover:underline mt-6" size="small"
                >Learn More</BaseButton
              >
            </BaseSheet>
          </div>
          <div class="w-full p-4 xl:w-3/12 sm:w-6/12">
            <BaseSheet class="px-6 py-16 rounded-lg shadow-lg sm:mt-16">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 24 24"
